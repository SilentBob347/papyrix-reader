...
class WifiSession final {
 public:
  WifiSession(WifiRadio& radio, Cpu& cpu) : radio_(radio), performanceLock_(cpu) {}
  ~WifiSession() { radio_.shutdown(); }
 ...
 private:
  WifiRadio& radio_;
  Cpu::PerformanceLock performanceLock_;
};
