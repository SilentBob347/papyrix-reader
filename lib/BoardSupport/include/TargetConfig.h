...
#if (PAPYRIX_TARGET_XTEINK_C3 + PAPYRIX_TARGET_X4PRO) != 1
#error "Set exactly one PAPYRIX_TARGET_* to 1: XTEINK_C3 or X4PRO"
#endif
...
#endif
#if PAPYRIX_TARGET_X4PRO && defined(CONFIG_IDF_TARGET_ESP32C3)
#error "PAPYRIX_TARGET_X4PRO requires the ESP32-S3 toolchain"
#endif
...
inline constexpr BoardId kBootBoardId = PAPYRIX_TARGET_XTEINK_C3 ? BoardId::X4 : BoardId::X4Pro;
